    ...
    let
      ...
      editions = {
        cliproxyapi = {
          version = "6.9.1";
          hashes = {
            "x86_64-linux" = "sha256-CMwjNIEUSbTle9crTOp1xOLhBp6iEAeJap/b6wX2pXQ=";
            "aarch64-linux" = "sha256-FWncAZHC2JMsnw3/KW3WYKvO9Wcyj6vky8BJvJaPkkk=";
            "x86_64-darwin" = "sha256-h9HR8L6sCvhgsaM2isxc7v7D+RCMdedBscWvQqc6EvA=";
            "aarch64-darwin" = "sha256-zMGGw/8vysAp2LTO4caF5uc0QHDzNcMPMB68LW8lsJs=";
          };
