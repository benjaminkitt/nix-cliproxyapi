    ...
    let
      ...
      editions = {
        ...
        cliproxyapi-plus = {
          version = "6.9.4-2";
          hashes = {
            "x86_64-linux" = "sha256-/HeWK5vMtlWybneHd/whVAYK9CVtR/71uYVtPp6B2Aw=";
            "aarch64-linux" = "sha256-IQh+Gu4T1AKAnqpyeKaf2aZFwyhsDvd5WA1qI6tbLpM=";
            "x86_64-darwin" = "sha256-8RjUcp4gbAcmm9gXSsOnwAe6MyjFsoeAo9fgZbhwDJs=";
            "aarch64-darwin" = "sha256-AgzAx8GbHY744NODFWC4xAkrGUx6edL3b4s7kwDwd04=";
          };
