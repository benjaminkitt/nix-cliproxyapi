    ...
    let
      ...
      editions = {
        cliproxyapi = {
          version = "6.9.7";
          hashes = {
            "x86_64-linux" = "sha256-BrjLoVhP3AtAZhRZDA7veukufACGWs56fMZrVCUFEkU=";
            "aarch64-linux" = "sha256-FER1FG4ynJar8b87QjLHhDcyWRU9319jMKd8ed1BTPA=";
            "x86_64-darwin" = "sha256-IMwZ+GD3XUpSRas3Xjs6H9HpEarBr181PT9t7eEzNu0=";
            "aarch64-darwin" = "sha256-P8+I4Mk1t6nKdiJcA5S85TtpbccaT5Aw89rIntNpHaY=";
          };
