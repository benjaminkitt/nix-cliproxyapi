{
  ...
  outputs = { self, nixpkgs, flake-utils }:
    let
      ...
      version = "6.7.22";
      hashes = {
        "x86_64-linux" = "sha256-/UnrX9MFJfpIo0rUhxSOn24OzZ7gJX06oe7IGyJhkqg=";
        "aarch64-linux" = "sha256-6NDKkfyTrOCfLAuEycIHhZ1WBlfF+TyRusYlNagGv0g=";
        "x86_64-darwin" = "sha256-Akvbmj4U018R+wulRVQeGXTrC15bPr8NL/V8wR+QT0g=";
        "aarch64-darwin" = "sha256-B6vrFiY8YD5Bv46AcFE98iA9VIxn1B9dxbrcgvV8PCw=";
      };
