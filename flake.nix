{
  ...
  outputs = { self, nixpkgs, flake-utils }:
    let
      ...
      version = "6.7.18";
      hashes = {
        "x86_64-linux" = "sha256-sAH69rlQwqjkP4i7LLmudurH3+wlfLnwxzBtchz7ia4=";
        "aarch64-linux" = "sha256-OI20OWv7fKQ85Kr9/b+msIn5ElV/uuGxaOJYWDT5Yrw=";
        "x86_64-darwin" = "sha256-il3Cr+MSOvMFxypbjZtC1ZzBePlGxqcuBbkdo4CxiUQ=";
        "aarch64-darwin" = "sha256-JYKI/4TxldtEMvowRTrBAqn40y6Hz+YFpmXuP6BP9JY=";
      };
