{
  ...
  outputs = { self, nixpkgs, flake-utils }:
    let
      ...
      version = "6.7.8";
      hashes = {
        "x86_64-linux" = "sha256-GTWSY4uxXZ9FohwDBvC94nLtbH15dU0pAxfOb/jizEQ=";
        "aarch64-linux" = "sha256-QxrrnMldFGEpXhZIsPPFiPeOERDqjcrpM9WtAa3Ux58=";
        "x86_64-darwin" = "sha256-Mk8OAgeENn0y3eyU9slkb2ovPBD0+Caw06LM9vHuAcg=";
        "aarch64-darwin" = "sha256-2ndcpsMKOPv6MGN3i3fXl6rbGJkLyBRBporDJlXHJ7c=";
      };
